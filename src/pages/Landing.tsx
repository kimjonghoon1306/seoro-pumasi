      ...
      {SLIDES.map((s, i) => (
        <div
          ...
          className={`${styles.slide} ${
            ...
            i === prev ? (dir === 'next' ? styles.slideExitLeft : styles.slideExitRight) :
            styles.slideHidden
          }`}
          ...
          <div className={styles.slideInner}>
            ...
            <div className={styles.slideLeft}>
              <div className={styles.slideNumTag}>
                ...
                <span className={styles.slideTag} style={{ color: s.accent, borderColor: `${s.accent}40` }}>
                  {s.tag}
                </span>
              </div>
