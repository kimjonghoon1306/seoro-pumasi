...
export default function Login() {
  ...
  function reset() {
    ...
    setNickname(''); setBlogUrl(''); setStep(1); setShowPw(false)
  }
  ...
  return (
    <div className={styles.wrap}>
        ...
        {tab === 'login' && (
          <form onSubmit={handleLogin} className={styles.form}>
            ...
            <label className={styles.label}>
              📧 이메일 주소
              <input className={styles.input} type="email" placeholder="예) abc@naver.com"
          ...
          <>
            ...
            {step === 1 && (
              <form onSubmit={handleStep1} className={styles.form}>
                ...
                <label className={styles.label}>
                  ...
                  <div className={styles.pwWrap}>
                    <input className={styles.input} type={showPw ? 'text' : 'password'}
                      placeholder="8자리 이상으로 만들어 주세요" value={password}
            ...
            {step === 2 && (
              <form onSubmit={handleSignup} className={styles.form}>
                ...
                <label className={styles.label}>
                  🙋 닉네임 (활동할 이름)
                  <input className={styles.input} type="text" placeholder="예) 꽃할머니, 블로그왕"
                ...
                <label className={styles.label}>
                  ...
                  <span className={styles.hint}>블로그 아이디만 입력해도 괜찮아요!</span>
                </label>
                {error && <div className={styles.error}>⚠️ {error}</div>}
      ...
      {/* 관리자 톱니바퀴 */}
      <Link href="/admin-login" className={styles.adminGear} title="관리자 로그인">
        ⚙️
      </Link>
    </div>
  )
